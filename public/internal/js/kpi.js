...
const CREATIVE_REGISTRY = [
  ...
  },
  {
    ...
    when: 'Era il paywall alla fine dell\'onboarding, subito dopo il reveal del piano. Ha avuto DUE prime schermate: il grafico fino al 2 luglio, poi l\'hero «programma pronto» (ProgramReadyHero, commit del 2/07 18:48). Quale delle due abbia visto chi non si ricava dai dati: il campo che le distingue (feature: chart | program_ready) è stato aggiunto il 20 luglio, dopo. Il passaggio è stato tolto dal flusso il 12 luglio, ed è la ragione per cui lo step «Vede il paywall (fine onboarding)» del funnel sprint vale zero.',
    exit: 'La × dell\'overlay (quando esisteva).',
    what: 'Gemella della «grafico», montata a fine onboarding: stesso grafico che si disegna, ma con la copy di fine onboarding («Ottieni un piano ancora più personalizzato…», CTA «Scopri HypeMove+»). È la ragione per cui lo step «Vede il paywall (fine onboarding)» del funnel sprint vale zero da settimane.',
    file: 'app/src/components/PremiumProposals/CoachAiChartPaywall/ProgramReadyHero.tsx',
    screens: [
      { idx: 0, t: 'Hero · due versioni', d: 'il grafico (nello scatto) fino al 2 luglio, poi «programma pronto» con la roadmap che si spunta — dai dati non si distingue chi ha visto cosa' },
      { idx: 1, t: 'Confronto', d: 'GRATIS vs HypeMove+' },
      { idx: 2, t: 'I prezzi', d: 'schermata piani standard' },
    ],
  },
