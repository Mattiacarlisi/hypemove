...
const CREATIVE_REGISTRY = [
  ...
  },
  {
    ...
    when: 'Era il paywall alla fine dell\'onboarding, subito dopo il reveal del piano, e i numeri qui sono tutti della build v0.7.1 (1 luglio). Il 2 luglio l\'hero è stato cambiato in «programma pronto» (ProgramReadyHero) ma quella versione NON è mai uscita: fra v0.7.1 e v0.7.7 (14 luglio) non c\'è stata nessuna release, e il 12 luglio il passaggio era già stato tolto dal flusso. La schermata «programma pronto» è vissuta solo nel codice.',
    ...
    screens: [
      { idx: 0, t: 'Hero grafico', d: 'la curva che si disegna, copy di fine onboarding · È QUELLO CHE HANNO VISTO' },
      { idx: 1, t: 'Confronto', d: 'GRATIS vs HypeMove+' },
      { idx: 2, t: 'I prezzi', d: 'schermata piani standard' },
    ],
  },
