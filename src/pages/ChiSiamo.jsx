...
import { LINKEDIN_URL, SITE_URL, SUPPORT_EMAIL, breadcrumb } from "../site.js";

export const meta = {
  title: "Chi siamo: le due persone dietro Hypemove",
  description:
    "Hypemove è fatta da Mattia Carlisi (founder, prodotto e marketing) e Danilo (sviluppo). Nasce in Italia per chi vuole muoversi di più e non riesce a essere costante.",
