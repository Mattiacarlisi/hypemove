  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        keywords: [
          "allenamento a casa",
          "allenamento a casa principianti",
          "home workout",
          "workout a casa",
          "allenarsi a casa",
          "Hypemove",
        ...
        <article>
          <section className="relative overflow-hidden px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
            ...
            <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(320px,0.55fr)]">
              ...
              <figure className="relative mx-auto w-full max-w-[34rem] self-center overflow-hidden rounded-[32px] border border-black/10 bg-white shadow-[0_30px_90px_rgba(0,0,0,0.08)] lg:justify-self-end">
                <img
          ...
          <section className="px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
            <div className="mx-auto max-w-7xl">
              <TextSection eyebrow="Il problema reale" title="Allenarti a casa funziona. Il problema è il metodo.">
                <p>
          ...
          <section className="bg-black px-4 py-20 text-white sm:px-6 sm:py-24 lg:px-8">
            <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[minmax(0,0.8fr)_minmax(320px,0.75fr)]">
             <TextSection 
                  dark 
                  eyebrow="Come iniziare bene" 
                  title={
                    <>
                      Come iniziare ad allenarti a casa <span className="text-[#FB8B04]"> senza mollare e ottenere risultati</span>
                    </>
                  }
>
                <p>
